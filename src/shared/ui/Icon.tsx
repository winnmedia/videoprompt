...
export function Icon({ name, size = 'md', className }: IconProps) {
    ...
    copy: (
      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2M8 16h8a2 2 0 002-2v-6M8 16l-2 2m10-10l2-2"
        />
      </svg>
    ),
    info: (
  ...
  return <div className={cn(sizes[size], className)}>{icons[name]}</div>;
}