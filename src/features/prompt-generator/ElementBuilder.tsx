...
export const ElementBuilder: React.FC<ElementBuilderProps> = ({
  ...
  const isFormValid = elements.characters.length > 0 && 
          ...
          {elements.characters.length === 0 ? (
            ...
            <div className="space-y-4">
              {elements.characters.map((character, index) => (
                <div key={character.id} className="border border-gray-200 rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                        ...
                        {character.reference_image_url ? (
                          <div className="space-y-2">
                            ...
                            <Button
                              ...
                              variant="outline"
                              size="sm"
                              onClick={() => updateCharacter(character.id, 'reference_image_url', undefined)}
                            >
                              이미지 제거
                            </Button>
                          </div>
          ...
          {elements.core_objects.length === 0 ? (
            ...
            <div className="space-y-4">
              {elements.core_objects.map((object, index) => (
                <div key={object.id} className="border border-gray-200 rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        onChange={(e) => updateCoreObject(object.id, 'description', e.target.value)}
                        ...
                        {object.reference_image_url ? (
                          <div className="space-y-2">
                            ...
                            <Button
                              ...
                              variant="outline"
                              size="sm"
                              onClick={() => updateCoreObject(object.id, 'reference_image_url', undefined)}
                            >
                              이미지 제거
                            </Button>
                          </div>
