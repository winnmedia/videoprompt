...
// 타입 정의
export type VideoStyle = typeof VIDEO_STYLES.visual[number] | typeof VIDEO_STYLES.genre[number] | typeof VIDEO_STYLES.mood[number] | typeof VIDEO_STYLES.quality[number] | typeof VIDEO_STYLES.director[number];
export type SpatialContext = typeof SPATIAL_CONTEXT.weather[number] | typeof SPATIAL_CONTEXT.lighting[number];
export type CameraSetting = typeof CAMERA_SETTINGS.lens[number] | typeof CAMERA_SETTINGS.movement[number];
