...
export function convertToV3(legacy: VideoPrompt): CineGeniusV3Prompt {
  return {
    ...
    userInput: {
      oneLineScenario: legacy.metadata.scene_description || '',
      targetAudience: '',
    },
    projectConfig: {
    ...
    promptBlueprint: {
      metadata: {
        promptName: legacy.metadata.project_name || 'Untitled',
        baseStyle: {
          visualStyle: legacy.metadata.base_style || '',
          genre: legacy.metadata.genre || '',
          mood: legacy.metadata.mood || '',
          quality: legacy.metadata.quality || '',
          styleFusion: {
            styleA: legacy.metadata.base_style || '',
            styleB: legacy.metadata.base_style || '',
            ratio: 1.0,
          },
        },
        spatialContext: {
          placeDescription: legacy.metadata.scene_description || '',
          weather: legacy.metadata.weather || '',
          lighting: legacy.metadata.lighting || '',
        },
        cameraSetting: {
          primaryLens: legacy.metadata.lens || '',
          dominantMovement: legacy.metadata.camera_movement || '',
          colorGrade: '',
        },
        deliverySpec: {
...
export function convertToLegacy(v3: CineGeniusV3Prompt): VideoPrompt {
  return {
    metadata: {
      project_name: v3.promptBlueprint.metadata.promptName,
      scene_description: v3.promptBlueprint.metadata.spatialContext.placeDescription,
      base_style: v3.promptBlueprint.metadata.baseStyle.visualStyle,
      genre: v3.promptBlueprint.metadata.baseStyle.genre,
      mood: v3.promptBlueprint.metadata.baseStyle.mood,
      quality: v3.promptBlueprint.metadata.baseStyle.quality,
      weather: v3.promptBlueprint.metadata.spatialContext.weather,
      lighting: v3.promptBlueprint.metadata.spatialContext.lighting,
      lens: v3.promptBlueprint.metadata.cameraSetting.primaryLens,
      camera_movement: v3.promptBlueprint.metadata.cameraSetting.dominantMovement,
    ...
    timeline: v3.promptBlueprint.timeline.map(segment => ({
      sequence: segment.sequence,
      timestamp: segment.timestamp || '',
      action: segment.visualDirecting,
      audio: segment.audioLayers.diegetic || '',
      camera_angle: segment.cameraWork.angle,
      camera_movement: segment.cameraWork.move,
      pacing: segment.pacingFX.pacing,
      audio_quality: segment.audioLayers.concept || '',
    })),
