...
export function ScenarioDeveloper({ onDevelopmentComplete, onError }: ScenarioDeveloperProps) {
  ...
  const [developmentStep, setDevelopmentStep] = useState<'input' | 'developing' | 'complete'>('input');
    ...
    return (
      <div className="p-6 bg-green-50 border border-green-200 rounded-lg">
        ...
        <p className="text-green-700 mb-4">
          입력하신 시나리오가 성공적으로 개발되었습니다. 이제 작가가 글을 쓰고 PD가 영상을 제작할 수 있습니다.
        </p>
    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          className="w-full h-24 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 resize-none"
