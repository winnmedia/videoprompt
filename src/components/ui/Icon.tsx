...
interface IconProps {
  name: 'wizard' | 'projects' | 'presets' | 'check' | 'lightning' | 'clock' | 'target' | 'gear' | 'plus' | 'minus' | 'edit' | 'delete' | 'save' | 'play' | 'pause' | 'stop' | 'arrow-left' | 'loading' | 'user' | 'send' | 'search' | 'copy' | 'info' | 'alert-circle' | 'spinner' | 'image' | 'video' | 'check-circle' | 'refresh-cw' | 'error';
  size?: 'sm' | 'md' | 'lg' | 'xl';
  className?: string;
}
