...
interface Console {
    ...
    /**
     * The **`logger.debug()`** static method outputs a message to the console at the 'debug' log level.
     *
    ...
    groupEnd(): void;
    /**
     * The **`logger.info()`** static method outputs a message to the console at the 'info' log level.
     *
     * [MDN Reference](https://developer.mozilla.org/docs/Web/API/console/info_static)
     */
    info(...data: any[]): void;
    /**
     * The **`logger.info()`** static method outputs a message to the console.
     *
