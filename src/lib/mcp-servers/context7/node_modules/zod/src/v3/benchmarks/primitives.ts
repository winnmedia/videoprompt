...
longEnumSuite
  ...
  .on("cycle", (e: Benchmark.Event) => {
    logger.info(`long z.enum: ${e.target}`);
  });
...
undefinedSuite
  ...
  .on("cycle", (e: Benchmark.Event) => {
    logger.info(`z.undefined: ${e.target}`);
  });
...
literalSuite
  ...
  .on("cycle", (e: Benchmark.Event) => {
    logger.info(`z.literal: ${e.target}`);
  });
