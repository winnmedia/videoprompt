...
\restrict EtLFlj2av7NefgaCFzeNLMHE6ysOIX7ADtYoeFjeYFLG9GvRGEMFk06vPcfZpcl
...
CREATE TABLE public."Comment" (
    ...
    feedback_data jsonb,
    rating integer,
    CONSTRAINT "Comment_comment_type_check" CHECK ((comment_type = ANY (ARRAY['general'::text, 'feedback'::text, 'review'::text, 'suggestion'::text, 'issue'::text]))),
    CONSTRAINT "Comment_rating_check" CHECK (((rating IS NULL) OR ((rating >= 1) AND (rating <= 5))))
);
...
--
-- Name: MigrationLog; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public."MigrationLog" (
    ...
    CONSTRAINT "MigrationLog_status_check" CHECK (((status)::text = ANY ((ARRAY['APPLIED'::character varying, 'ROLLED_BACK'::character varying, 'FAILED'::character varying])::text[])))
);


--
-- Name: MigrationLog_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."MigrationLog_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: MigrationLog_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."MigrationLog_id_seq" OWNED BY public."MigrationLog".id;
...
CREATE TABLE public."ShareToken" (
    ...
    created_at timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    user_id text,
    permissions jsonb DEFAULT '{"read": true, "share": false, "write": false}'::jsonb NOT NULL,
    CONSTRAINT sharetoken_role_check CHECK ((role = ANY (ARRAY['viewer'::text, 'editor'::text, 'admin'::text, 'owner'::text, 'commenter'::text])))
);
...
CREATE TABLE public."VideoAsset" (
    ...
    CONSTRAINT "VideoAsset_quality_score_check" CHECK (((quality_score >= 0.0) AND (quality_score <= 10.0))),
    CONSTRAINT videoasset_provider_check CHECK ((provider = ANY (ARRAY['runwayml'::text, 'pika'::text, 'stable-video'::text, 'cogvideo'::text, 'local'::text]))),
    CONSTRAINT videoasset_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'processing'::text, 'completed'::text, 'failed'::text, 'cancelled'::text])))
);
...
--
-- Name: MigrationLog id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."MigrationLog" ALTER COLUMN id SET DEFAULT nextval('public."MigrationLog_id_seq"'::regclass);
...
--
-- Name: MigrationLog MigrationLog_migration_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."MigrationLog"
    ADD CONSTRAINT "MigrationLog_migration_id_key" UNIQUE (migration_id);


--
-- Name: MigrationLog MigrationLog_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_comment_rating; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_comment_rating ON public."Comment" USING btree (rating DESC) WHERE (rating IS NOT NULL);


--
-- Name: idx_comment_type_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_comment_type_target ON public."Comment" USING btree (comment_type, "targetType", "targetId");


--
-- Name: idx_migration_log_applied_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_migration_log_applied_at ON public."MigrationLog" USING btree (applied_at);
...
CREATE INDEX idx_migration_log_status ON public."MigrationLog" USING btree (status);


--
-- Name: idx_prompt_cinegenius_version; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prompt_cinegenius_version ON public."Prompt" USING btree (cinegenius_version) WHERE (cinegenius_version IS NOT NULL);


--
-- Name: idx_sharetoken_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sharetoken_active ON public."ShareToken" USING btree (token, expires_at);


--
-- Name: idx_sharetoken_role_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sharetoken_role_target ON public."ShareToken" USING btree (role, "targetType", "targetId");


--
-- Name: idx_videoasset_quality_score; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_videoasset_quality_score ON public."VideoAsset" USING btree (quality_score DESC) WHERE (quality_score > 0.0);


--
-- Name: idx_videoasset_status_provider; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_videoasset_status_provider ON public."VideoAsset" USING btree (status, provider);
...
\unrestrict EtLFlj2av7NefgaCFzeNLMHE6ysOIX7ADtYoeFjeYFLG9GvRGEMFk06vPcfZpcl
